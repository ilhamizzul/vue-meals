<template>
  <div class="max-w-[800px] mx-auto p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2">
      <div>
        <h2 class="text-2xl font-semobold mb-2">Ingredients</h2>
        <ul>
    ...
    <div class="mt-4">
      ...
      <a 
        :href="meal.strSource" 
        target="_blank" 
        class="ml-3 px-3 py-2 rounded border-2 border-transparent text-indigo-600 hover:cursor-pointer transition-colors"
      >
